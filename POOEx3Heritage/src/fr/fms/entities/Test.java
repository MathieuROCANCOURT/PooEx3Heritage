...
public class Test {
	...
	public static void main(String[] args) {
		...
		Employee gate = new Employee("Gate", "Bill", 65, "USA", new Capital("Washington", "USA", 7_600_000, "W-M"),
				100_000.0, "Fondation B&M");
		...
		/** Test Salesman class **/
		Salesman dupont = new Salesman("Dupont", "Robert", 50, "Rue des rosiers à Toulouse",
				new City("Limoges", "France"), "brico", 5.0);
